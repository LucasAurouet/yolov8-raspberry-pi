...
model = YOLO('/home/lucas/Desktop/yolov8-raspberry-pi/weights/finetuned_weights.pt')

#img_test = cv2.imread(r"/home/lucas/Desktop/yolov8-raspberry-pi/test_image.jpg")
